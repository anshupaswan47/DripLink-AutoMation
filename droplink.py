...
def vpn(driver):
    ...
    waitforid('url')
    try:
        # driver.find_element(By.XPATH,x_input).sendkeys('https://droplink.co/bwXe')
        driver.find_element(By.XPATH,value=x_input).sendkeys('https://droplink.co/bwXe')
    except:
        pass
    clickby_id('requestSubmit')
    start(driver)
